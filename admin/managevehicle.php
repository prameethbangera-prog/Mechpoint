        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
			<div class="page-header">
              <h3 class="page-title">Manage Vehicle</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="hom.php">Home</a></li>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample"action="#" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Vehiclename</label>
                        <input type="text" class="form-control" name="vehiclename" id="exampleInputUsername1" placeholder="Username" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Vehicle Image</label>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
        ...
        $folder = "vimg/".$filename;
		
        if (move_uploaded_file($tempname, $folder))  
		{
			$query ="INSERT INTO managevehicle(image,vehiclename) VALUES('".$filename."','".$vehiclename."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='managevehicle.php'; </script>";
        }else{
            echo "<script>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover">
						...
						<?php
								include 'config.php';
								$sql1 = "select * from managevehicle";
                          ...
                          <tr>
                            ...
                            <td><img src="vimg/<?php echo $image; ?>" style="width:200px; height:170px;" alt="image">
                            </td>
                            <td>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from managevehicle where id='".$selectano."'";
