                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="#" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Vehicle Name</label>
						  ...
						  <?php
								...
								?>
			              <option value="<?php echo $id; ?>"> <?php echo $vehiclename; ?></option>
								<?php
								}
								}
								?>
                      ...
                      <div class="form-group">
                        ...
                        <input type="Text" name="service" class="form-control" id="exampleInputEmail1" placeholder="Mention required service" />
                      </div>
					  <div class="form-group">
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
		...
		{
			$query ="INSERT INTO manageservice(image,vehiclename,service) VALUES('".$filename."','".$vehiclename."','".$service."')";
		...
		?>
			  ...
			  <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Vehicles Detailes</h4>
                      ...
                      <table class="table table-hover">
						...
						<?php
                          ...
                          <tr>
                            ...
                            <td><img src="simg/<?php echo $image; ?>" style="width:200px; height:170px;" alt="image">
                            </td>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from manageservice where id='".$selectano."'";
