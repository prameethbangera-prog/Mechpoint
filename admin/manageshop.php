          ...
          <div class="content-wrapper pb-0">
			...
			<div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Shop Detailes</h4>
                    
                    <form class="forms-sample" action="#" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Shop Name</label>
                        <input type="text" class="form-control" name="sname"id="exampleInputUsername1" placeholder="ShopName" />
                      </div>
					  ...
					  <div class="form-group">
                        ...
                        <input type="Text" class="form-control"maxlength="10" name="phone"id="exampleInputEmail1" placeholder="PhoneNumber" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Address</label>
                        <input type="Textarea" class="form-control" name="address"id="exampleInputEmail1" placeholder="Address" />
                      </div>
                     <div class="form-group">
                        <label for="exampleInputEmail1">Pincode</label>
                        <input type="Text" class="form-control"maxlength="6" name="pincode"id="exampleInputEmail1" placeholder="Pincode" />
                      </div>
					  <div class="form-group">
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
        ...
        $folder = "shimg/".$filename;
		
        if (move_uploaded_file($tempname, $folder))  
		{
			$query ="INSERT INTO manageshop(image,sname,email,phone,address,pincode,password) VALUES('".$filename."','".$sname."','".$email."','".$phone."','".$address."','".$pincode."','".$password."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='manageshop.php'; </script>";
        }else{
            echo "<script>
...
?>
			  ...
			  <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">View Shop</h4>
                      ...
                      <table class="table table-hover">
						...
						<?php
                          ...
                          <tr>
                            ...
                            <td><img src="shimg/<?php echo $image; ?>" style="width:200px; height:170px;" alt="image">
                            </td>
						  ...
						  <input type="text" name="id[]" value="<?php echo $id; ?>" hidden="true">
                               <button type="submit"  name="delete" class="btn btn-danger btn-fw"> Delete </button>
							   </form>
                            </td>
                          </tr>
						  <?php
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from manageshop where id='".$selectano."'";
