  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
                  ...
                  <div class="card-body">
                   <form class="forms-sample" action="#" method="post">
                      <div class="form-group">
                        ...
                        <input type="email" name="shopemail" class="form-control" id="exampleInputUsername1" placeholder="ShopName" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">User Email</label>
                        <input type="text"name="useremail" class="form-control" id="exampleInputEmail1" placeholder="Email" />
                      </div>
					  <div class="form-group">
                        <label for="exampleInputEmail1">Message</label>
                        <input type="text"name="message2" class="form-control" id="exampleInputEmail1"  placeholder="Message" />
                      </div>
		...
		$query = "INSERT INTO addmessage(shopemail,useremail,message2)VALUES('".$shopemail."','".$useremail."','".$message2."')";
           $result=mysqli_query($con,$query);
		   if($result){
			  echo"<script>
                      alert('Uploaded Successfully');			  
                       location.href='addmessage.php'; </script>";
		   }
		else{
		 echo"<script>
                  ...
                  <div class="card-body">				
                    ...
                    <div class="table-responsive">
                      <table class="table table-hover">
						...
						<?php
								include 'config.php';
								$loggedInShopEmail = $_SESSION['mechshop'];
								$sql1 = "select shopemail, useremail,message2 from addmessage where shopemail='$loggedInShopEmail'";
