        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
			<div class="page-header">
              <h3 class="page-title">View Payment</h3>
			  ...
			  <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
					...
					error_reporting(1);
					include("config.php");
				$sql = "SELECT payment.*,bill.* from payment inner join bill on bill.bno=payment.bno where bill.shopemail='".$_SESSION['mechshop']."'";
					...
					?>
                            <tr>
                                <td><?php echo $sl; ?></td>
								<td>B00<?php echo $bno; ?></td>
								<td><?php echo $pytrid; ?></td>
                                <td><?php echo $date; ?></td>
