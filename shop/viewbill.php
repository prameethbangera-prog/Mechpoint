        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
			<div class="page-header">
              <h3 class="page-title">View Bill</h3>
			  ...
			  <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
					...
					include("config.php");
					$status='confirm';
					$sql = "SELECT bno, fname, phone, address,pay from bill where status='".$status."' and shopemail='".$_SESSION['mechshop']."' group by bno";
					...
					if($count>0)
					{
						...
						?>
						  ...
						  <input type="text" name="bid[]" value="<?php echo $bno; ?>" hidden="true">
							<button type="submit"name="details" id="viewbill" class="btn btn-danger btn-fw"> View Bill</button></td>
							</form>
                            </tr>
                       <?php
						}
