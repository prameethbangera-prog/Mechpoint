        ...
        <ul class="nav">
		  ...
		  <li class="nav-item">
            <a class="nav-link" href="viewfeedbank.php">
              <i class="mdi mdi-table-large menu-icon"></i>
              <span class="menu-title">View Feedbank</span>
            </a>
          </li>
		  <li class="nav-item">
            ...
            <ul class="navbar-nav">
             ...
             <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  ...
                  <span class="profile-name">Update</span>
                </a>
			  ...
			  <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <?php
								include 'config.php';
								$sql1 = "select * from manageshop where email='".$_SESSION['mechshop']."' ";
                   ...
                   <form class="forms-sample" method="post" action="#">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sname" value="<?php echo $sname;?>"  placeholder="Name" />
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Email</label>
                        <input type="email" class="form-control"name="email"value="<?php echo $email;?>"  placeholder="Email" readonly="true"/>
                      </div>
					  <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control"name="pincode"value="<?php echo $pincode;?>"   placeholder="pincode" />
                      </div>
...
if(isset($_POST['update']))
{
	...
	include("config.php");
		...
		$query="update manageshop set sname='".$sname."', phone='".$phone."', address='".$address."', pincode='".$pincode."'
		where email='".$_SESSION['mechshop']."' ";
		...
		echo "<script>
			...
			echo "<script> location.href='manageprofile.php'; </script>";
