...
<html lang="en">
  <head>
	...
	#delete:hoverable-collapse{
		
		background-color:#0a0a85;
	}
	h4
	{
		margin:3% 10%;
                ...
                <div class="card">
                  <div class="card-body">
				   ...
				   <?php
								...
								?>
                   <td> <img src="../admin/shimg/<?php echo $image; ?>" style=" width:400px; height:500px; border-radius:100%"></td>
				   <div style="width:100%;height:250px;">
					<h4><b>Name:<?php echo $sname; ?> </h4>
                    <h6>Eail:<?php echo $email; ?></h6>
                   <h6>Phone:<?php echo $phone; ?></h6>
					<h6>Address:<?php echo $address; ?></h6>
					<h6>PINCODE:<?php echo $pincode; ?></h6>
					<?php
								}
								}
                            ?>		
                 ...
                 <button type="submit" name="update" class="btn btn-danger btn-fw"> Update Profile</button>
                  </div>
				  </form>
				  <?php
