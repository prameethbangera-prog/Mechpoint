        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
			<div class="page-header">
              <h3 class="page-title">View Request</h3>
                  ...
                  <div class="card-body">
                    ...
                    <div style="overflow-x:auto;">
                      <table class="table table-hover">
						...
						<?php
								include 'config.php';
								$sql1 = "select * from request where shopemail='".$_SESSION['mechshop']."'";
								$result1 = mysqli_query($con,$sql1);
								if(!$result1){
									die('Query executed Failed:' .mysqli_error($con));
								}
								$sl=0;
						  ...
						  <input type="hidden" name="id[]" value="<?php echo $id; ?>" >
							<button type="submit" name="submit" class="btn btn-danger btn-fw"> Confirm</button>
							</form></td>
							</tr>
								 <?php
								 }
								 if(isset($_POST['submit']))
								 {
								  ...
								  $query="update request set status='confirmed' where id in($ids) and shopemail='".$_SESSION['mechshop']."'";
