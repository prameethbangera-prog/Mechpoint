                        ...
                        <form method="post" action="#">
                            <div class="row g-3">
                                <div class="col-10 col-sm-10">
                                    <input type="text" name="pincode" class="form-control border-0" placeholder="Enter pincode" style="height: 55px;">
                                </div>
                                <div class="col-2">
                                    <button class="btn btn-secondary w-100 py-3" name="search" type="submit">Submit</button>
                                </div>
	 ...
	 <div class="col-12">
					...
					if(isset($_POST['search'])) {
						$pincode=$_POST['pincode'];
								...
								include 'config.php';
								$sql1 = "select * from manageshop  WHERE pincode='".$pincode."'";
                        ...
                        <div class="col-md-4">
							...
							<img src="../admin/shimg/<?php echo $filename; ?>" style="height:250px;"></img>
							<center>
                                <h5 class="text-uppercase"><?php echo $sname; ?></h5>
                                <p class="m-0"><i class="fa fa-envelope-open text-primary me-2"></i><?php echo $email; ?></p>
								<p>Contact no:<?php echo $phone; ?></p>
								</center>
								<center>
								 <div class="col-6">
								<a  href="bookservice.php?confirm=<?php echo $email; ?>"  class="btn btn-secondary w-100 py-3" type="submit">Send Request</a>
								</div>
								</center>
                            </div>
                        </div>
                       ...
                       <?php
								...
								{
									echo "<div class='container text-center'><h>No shop found for the pincode you entered.</h3></div>";
								}
					}
					?>
										<?php
if(isset($_GET['confirm']))
{
		...
		$query = "INSERT INTO request(rid,shopemail)VALUES('".$rid."','".$confirm."')";
