...
<body>
   ...
   <!-- Navbar Start -->
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <p class="mb-4"> Welcome to Mech Point, your trusted destination for top-notch mechanical solutions. At Mech Point, we take pride in offering expert services that cater to a diverse range of mechanical needs. Whether you're in need of precision automotive repairs, custom machining, or general mechanical services, we've got you covered. Maintaining and repairing cars, trucks, motorcycles, etc.
    ...
    <!-- About End -->
	<center> <a href="bookservice.php" class="btn btn-primary py-3 px-5">Book Now<i class="fa fa-arrow-right ms-3"></i></a>	</center> 
