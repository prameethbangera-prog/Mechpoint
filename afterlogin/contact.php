            ...
            <div class="row g-4">
                    ...
                    <div class="row gy-4">
                        <div class="col-md-4">
                            <div class="bg-light d-flex flex-column justify-content-center p-4">
                                ...
                                <p class="m-0"><i class="fa fa-envelope-open text-primary me-2"></i>mechpoint@gmai.com</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="bg-light d-flex flex-column justify-content-center p-4">
                                <h5 class="text-uppercase">// General //</h5>
                                <p class="m-0"><i class="fa fa-envelope-open text-primary me-2"></i>mechan@gmail.com</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="bg-light d-flex flex-column justify-content-center p-4">
                                <h5 class="text-uppercase">// Technical //</h5>
                                <p class="m-0"><i class="fa fa-envelope-open text-primary me-2"></i>technision@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                    <iframe class="position-relative rounded w-100 h-100"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31115.072456247763!2d74.83650731035769!3d12.883008145130617!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba35a3ec4efbfc7%3A0xffff067b3ac979d4!2sKadri%2C%20Mangaluru%2C%20Karnataka!5e0!3m2!1sen!2sin!4v1706600716972!5m2!1sen!2sinhttps://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31115.072456247763!2d74.83650731035769!3d12.883008145130617!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba35a3ec4efbfc7%3A0xffff067b3ac979d4!2sKadri%2C%20Mangaluru%2C%20Karnataka!5e0!3m2!1sen!2sin!4v1706600716972!5m2!1sen!2sin"
							...
							<?php
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text"  name="fname" class="form-control" id="name" readonly="true" value="<?php echo $fname; ?>" >
                                        <label for="name">Your Name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="email"  name="email"  class="form-control" id="email" value="<?php echo $email; ?>" readonly="true">
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
		...
		$query = "INSERT INTO feedbank(fname,email,message)VALUES('".$fname."','".$email."','".$message."')";
