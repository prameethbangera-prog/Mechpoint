...
<body>
   ...
   <!-- Team Start -->
   <?php 	$rid=$_SESSION['item'];?>
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                
                <h1 class="mb-5">Select Your Vehicle</h1>
            </div>
            <div class="row g-4">
			<?php
								include 'config.php';
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="../admin/vimg/<?php echo $filename; ?>" alt=""style="height:190px;">
                            <div class="team-overlay position-absolute start-0 top-0 w-100 h-100">
                                
                                <a class="btn btn-square mx-1" href="vservice.php?name=<?php echo $name; ?>&rid=<?php echo $rid; ?>"><i class="fa fa-check"></i></a>
