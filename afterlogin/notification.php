...
<!-- Topbar Start -->
 ...
 <!-- Navbar Start -->
    ...
    <!-- Contact Start -->
   <section  id="notification" class="notification" style="margin-top:30px;">
      <div class="container">
	   <div class="row">
	    <div class="col-lg-8 mx-auto">
		<h2 class="text-center">Notification</h2>
		<div class="Notification-list">
		<div class="Notification-item" style="padding:20px;box-shadow:0px 0px 15px -4px">
     
       <h4>Admin Message</h4>
	   <?php
                            include 'config.php';
                            $sql1 = "SELECT message FROM addmessage";
	   ...
	   <?php
                            include 'config.php';
                            $sql2 = "SELECT * FROM addmessage WHERE useremail='" . $_SESSION['mechuser'] . "'";
                            $result2 = mysqli_query($con, $sql2);
                            $num2 = mysqli_num_rows($result2);
                            if ($num2 > 0) {
                                echo "<table>"; 
                                while ($row2 = mysqli_fetch_array($result2)) {
                                    $shopemail = $row2['shopemail'];
                                   
                                    $message2 = $row2['message2'];
                                    echo "<tr><td>FROM: $shopemail</td></tr>";
                                  
                                    echo "<tr><td> $message2</td></tr>";
                                }
                                echo "</table>"; 
                            } else {
                                echo "<p>No Message</p>"; 
