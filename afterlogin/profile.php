...
.container1 {
  ...
  box-shadow: 0 0 15px rgba(0, 0, 0, 0.1);
    background-image: url("img/pfbg1.jpg");"
...
<!-- Topbar Start -->
 ...
 <!-- Navbar Start -->
   ...
   <section class="container1" style="margin-left:300px;">
	  ...
	  <?php
								include 'config.php';
								$sql1 = "select * from user  where email='".$_SESSION['mechuser']."'";
								...
								$phone=$row1['phone'];
								$datebirth=$row1['datebirth'];
								}}
								?>
      <form action="#" class="form" method="post">
        <div class="input-box">
          <label>Full Name</label>
          <input type="text" name="fname" placeholder="Enter full name" value="<?php echo $fname; ?>"required />
        </div>

        <div class="input-box">
          <label>Email Address</label>
          <input type="email" name="email"placeholder="Enter email address" value="<?php echo $email; ?>"  readonly="true" required />
        </div>
        ...
        <div class="column">
          ...
          <div class="input-box">
            ...
            <input type="date"name="datebirth" placeholder="Enter birth date" value="<?php echo $datebirth; ?>" required />
          </div>
        </div>
       
        <div class="input-box address">
          <label>Address</label>
          <input type="text" name="address"placeholder="Enter street address" value="<?php echo $address; ?>" required />
...
if(isset($_POST['update']))
{
	...
	include("config.php");
		...
		$query = "update user set fname='".$fname."',phone='".$phone."',address='".$address."',datebirth='".$datebirth."' where email='".$_SESSION['mechuser']."'";
