    ...
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/carousel-bg-1.jpg);">
        <div class="container-fluid page-header-inner py-5">
            <div class="container text-center">
                <h1 class="display-3 text-white mb-3 animated slideInDown">View Bill</h1>
...
<?php
					include("config.php");
					$status='confirm';
					$sql = "SELECT bno, fname, phone, address from bill where status='".$status."' and phone='".$phone."' group by bno";
...
<tr>
 <td><?php echo $sl; ?></td>
 <td>B.NO<?php echo $bno; ?></td>
 <td><?php echo $fname; ?></td>
 <td><?php echo $phone; ?></td>
 <td><?php echo $address; ?></td>
 <td>
 <form  method="post"  action="#" >
						  <input type="text" name="bid[]" value="<?php echo $bno; ?>" hidden="true">
							<button type="submit" name="details" id="viewbill" class="btn btn-danger btn-fw"> View Bill</button>
							</form></td>
 </tr>
  <?php
						}
